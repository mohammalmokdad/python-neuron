# M6 Motorneuron Type FR, passive parameters generated from PassParams.py
...
fig = fig.update_layout({
    ...
    "title":'M6 Motorneuron Voltage Response to 1 nA Current'
})
fig.show()