# M3 Motorneuron Type FF, passive parameters generated from PassParams.py
...
fig = fig.update_layout({
    ...
    "title":'M3 Motorneuron Voltage Response to 1 nA Current'
})
fig.show()