...
#define hmin hmin_na3rp
 double hmin = 0.5;
#define htau htau_na3rp
 double htau = 0;
#define hinf hinf_na3rp
 double hinf = 0;
#define mmin mmin_na3rp
 double mmin = 0.02;
#define mtau mtau_na3rp
 double mtau = 0;
#define minf minf_na3rp
 double minf = 0;
#define qq qq_na3rp
 double qq = 10;
...
#define qa qa_na3rp
 double qa = 7.2;
#define qinf qinf_na3rp
 double qinf = 4;
#define sinf sinf_na3rp
 double sinf = 0;
#define tq tq_na3rp
 double tq = -55;
...
#define tha tha_na3rp
 double tha = -30;
#define thinf thinf_na3rp
 double thinf = -50;
#define taus taus_na3rp
 double taus = 0;
 ...
 "qq_na3rp", &qq_na3rp,
 "tq_na3rp", &tq_na3rp,
 "thinf_na3rp", &thinf_na3rp,
 "qinf_na3rp", &qinf_na3rp,
 "a0s_na3rp", &a0s_na3rp,
 "b0s_na3rp", &b0s_na3rp,
 ...
 "avs_na3rp", &avs_na3rp,
 "bvs_na3rp", &bvs_na3rp,
 "minf_na3rp", &minf_na3rp,
 "hinf_na3rp", &hinf_na3rp,
 "mtau_na3rp", &mtau_na3rp,
 "htau_na3rp", &htau_na3rp,
 "sinf_na3rp", &sinf_na3rp,
 "taus_na3rp", &taus_na3rp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na3rp na3rp.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 70 in file na3rp.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "na3rp.mod";
static const char* nmodl_file_text = 
  "TITLE na3rp\n"
  ": Na current \n"
