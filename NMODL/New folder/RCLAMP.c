...
#define nrn_init _nrn_init__RClamp
#define _nrn_initial _nrn_initial__RClamp
#define nrn_cur _nrn_cur__RClamp
#define _nrn_current _nrn_current__RClamp
#define nrn_jacob _nrn_jacob__RClamp
#define nrn_state _nrn_state__RClamp
#define _net_receive _net_receive__RClamp 
...
#define pkamp _p[2]
#define pkamp_columnindex 2
#define bias _p[3]
#define bias_columnindex 3
#define i _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 RClamp RCLAMP.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   if ( t < del ) {
     ...
     if ( t < del + ( dur / 2.0 ) ) {
       i = ( t - del ) * ( pkamp / ( dur / 2.0 ) ) + bias ;
       }
     else {
       if ( t < del + 2.0 * ( dur / 2.0 ) ) {
         i = ( t - del - ( dur / 2.0 ) ) * ( - pkamp / ( dur / 2.0 ) ) + pkamp + bias ;
         }
       else {
         i = 0.0 ;
         }
...
#if NMODL_TEXT
static const char* nmodl_filename = "RCLAMP.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
