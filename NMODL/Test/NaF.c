...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lam = 0.1 * ( - ( _lv + 40.0 ) / ( exp ( - ( _lv + 40.0 ) / 10.0 ) - 1.0 ) ) ;
   _lbm = 4.0 * exp ( - ( _lv + 65.0 ) / 18.0 ) ;
   _lah = .07 * exp ( - ( _lv + 65.0 ) / 20.0 ) ;
   _lbh = 1.0 / ( exp ( - ( _lv + 35.0 ) / 10.0 ) + 1.0 ) ;
   mtau = 1.0 / ( _lam + _lbm ) ;
   minf = _lam / ( _lam + _lbm ) ;
   htau = 1.0 / ( _lah + _lbh ) ;
   hinf = _lah / ( _lah + _lbh ) ;
